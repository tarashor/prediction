 ...
 */
public class BasicFeatures implements Features {
    ...
    public Vector getFeaturesFromDate(Date date, Statistic inputData) {
        ...
        int daysToNextHolidayUkr = Statistic.getHoursToNextHolidayUkr(date);
        features.set(7, daysToNextHolidayUkr);
        int daysToPrevHolidayUkr = Statistic.getHoursToPrevHolidayUkr(date);
